...
exports.setStateReplay = exports.setStateRecord = exports.setStateReady = exports.stateIsReady = exports.stateIsRecord = exports.stateIsReplay = exports.clearStateStorage = exports.DOMREPLAY_STATE_READY = exports.DOMREPLAY_STATE_RECORD = exports.DOMREPLAY_STATE_REPLAY = exports.DOMREPLAY_STATE_STORAGE_KEY = undefined;

var _error = require('./error');

var DOMREPLAY_STATE_STORAGE_KEY = exports.DOMREPLAY_STATE_STORAGE_KEY = 'DOMREPLAY_STATE'; /**
...
var setStateRecord = exports.setStateRecord = function setStateRecord() {
  ...
  return new Promise(function (resolve, reject) {
    if (force || stateIsReady()) {
      ...
      reject((0, _error.createStateError)('Tried to change state from "' + getState() + '" to "' + DOMREPLAY_STATE_RECORD + '"'));
    }
  });
};
...
var setStateReplay = exports.setStateReplay = function setStateReplay() {
  ...
  return new Promise(function (resolve, reject) {
    if (force || stateIsReady()) {
      ...
      reject((0, _error.createStateError)('Tried to change state from "' + getState() + '" to "' + DOMREPLAY_STATE_REPLAY + '"'));
    }
  });
};